...
export default function Ministry() {
  ...
  >
      <div className="w-full max-w-5xl flex flex-col items-start px-4 sm:px-6 md:px-8 lg:px-6">
        <motion.h2
          className="fellowship-header text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-foreground leading-tight text-balance"
          style={{ fontFamily: '"Bebas Neue", sans-serif', color: "#1560BD", position: 'relative' }}
        ...
        <motion.div
          className="flex flex-col md:flex-row items-start justify-center gap-4 md:gap-8 lg:gap-[160px] mt-[10px] mb-10 w-full"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
      ...
      >
        {ministries.map((ministry, index) => (
          ...
          >
            ...
            <motion.p
              className="text-black-700 text-center mb-4 text-base sm:text-base md:text-base"
              initial={{ opacity: 0, y: 10 }}
              whileInView={{ opacity: 1, y: 0 }}
