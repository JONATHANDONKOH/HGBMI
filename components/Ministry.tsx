...
export default function Ministry() {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      const cardWidth = container.scrollWidth / ministries.length;
  ...
  >
      ...
      <div className="w-full max-w-7xl">
        <div
          ...
          className="flex overflow-x-auto gap-4 sm:gap-5 md:gap-6 lg:gap-8 w-full px-4 sm:px-5 md:px-6 lg:px-6 pb-4 snap-x snap-mandatory scrollbar-hide"
          ...
          {ministries.map((_, index) => (
            <button
              ...
              className={`w-2 h-2 rounded-full transition-all duration-200 ${
                index === activeIndex ? 'bg-blue-600 w-8' : 'bg-white/50'
              }`}
