      ...
      <section className="w-full py-10 mt-8">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center mb-16" ref={headerRef}>
            ...
            >
              United in faith, love, and service. Join us on this spiritual journey.
            </p>
          </div>

          {/* Image Grid */}
          <div
            className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16 animate-fade-in-up-stagger"
            ref={gridRef}
          >
          ...
          <div className="mb-16" style={{ perspective: '1500px' }}>
            ...
            <div
              ...
              style={{ transform: 'translateZ(50px)', position: 'relative' }}
            >
              <h3
          ...
          <div className="rounded-2xl p-12 text-center">
            ...
            <p
              ...
              style={{ fontFamily: '"Poppins", sans-serif', fontWeight: 400 }}
            >
              Whether you're new to faith or have been walking with God for years, there's a place
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="/about">
                <Button
                  size="lg"
                  variant="outline"
                  className="border-2 border-[#2563eb] text-[#2563eb] hover:bg-[#2563eb] hover:text-white px-8 py-6 text-lg rounded-full transition-all duration-300 bg-transparent animate-bounce hover:animate-none"
                  style={{ fontFamily: '"Poppins", sans-serif', fontWeight: 700 }}
                >
                  Learn More
                </Button>
