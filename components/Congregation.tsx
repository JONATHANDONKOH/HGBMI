...
return ( <main> <section className="w-full py-10 mt-8"> <div className="max-w-7xl mx-auto px-6">
{/* Header */} <div className="text-center mb-16" ref={headerRef}>
<h2
...
>
A diverse community of believers </h2>
