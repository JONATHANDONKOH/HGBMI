...
export default function TemaFellowshipPage() {
  return (
      ...
      >
        ...
        <div className="relative z-10 text-center text-white px-6 max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-3xl lg:text-2xl mb-8 animate-fade-in delay-300" style={{ textShadow: '2px 2px 4px rgba(0,0,0,0.6)' }}>
            Uplifting worship through music and praise. Join our vibrant community in Tema.
          </p>
      ...
      <main className="container mx-auto px-6 py-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="bg-white rounded-xl p-8 shadow-lg">
              ...
              <p className="text-lg text-[#374151] leading-relaxed mb-6">
                The Tema Fellowship is a dynamic community of believers committed to worship, fellowship,
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-[#374151]">Tema Community Center, Tema</span>
                </div>
                <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-[#374151]">Led by Pastor John Mensah</span>
                </div>
              </div>
            </div>
        ...
        <section className="bg-[#1e3a8a] rounded-2xl p-12 text-white text-center">
          ...
          <p className="text-lg mb-8 max-w-2xl mx-auto">
            Become part of our loving community in Tema. All are welcome to experience God's love and grace.
          </p>
